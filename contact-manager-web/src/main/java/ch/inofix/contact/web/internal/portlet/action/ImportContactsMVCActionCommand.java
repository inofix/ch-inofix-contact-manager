...
public class ImportContactsMVCActionCommand extends BaseMVCActionCommand {
...
//        exportImportConfiguration.setSettings(settings);
    ...
    private static Log _log = LogFactoryUtil.getLog(ImportContactsMVCActionCommand.class.getName());
