<%--
    export_contacts.jsp: configure the contacts export.
    
    Created:    2017-06-21 09:33 by Christian Berndt
    Modified:   2017-11-14 20:04 by Christian Berndt
    Version:    1.0.1
--%>
...
<div class="container-fluid-1280">
    <portlet:actionURL name="exportContacts" var="restoreTrashEntriesURL">
<%--     <portlet:actionURL name="editExportConfiguration" var="restoreTrashEntriesURL"> --%>
    ...
    <%
        int incompleteBackgroundTaskCount = BackgroundTaskManagerUtil.getBackgroundTasksCount(scopeGroupId, ContactExportBackgroundTaskExecutor.class.getName(), false);
    %>
    ...
    <portlet:actionURL name="exportContacts" var="exportContactsURL">
        <portlet:param name="mvcRenderCommandName" value="exportContacts" />
        <portlet:param name="redirect" value="<%= redirect %>"/>
    </portlet:actionURL>

    <aui:form action='<%= exportContactsURL + "&etag=0&strip=0" %>' cssClass="lfr-export-dialog" method="post" name="fm1">
