...
<%
    ...
    portletURL.setParameter("mvcRenderCommandName", "exportContacts");
    ...
    >
        ...
        <%
            ...
            if (navigation.equals("all")) {
                backgroundTasksCount = BackgroundTaskManagerUtil.getBackgroundTasksCount(groupId, ContactExportBackgroundTaskExecutor.class.getName());
                backgroundTasks = BackgroundTaskManagerUtil.getBackgroundTasks(groupId, ContactExportBackgroundTaskExecutor.class.getName(), searchContainer.getStart(), searchContainer.getEnd(), searchContainer.getOrderByComparator());
            }
            else {
...
<%
    int incompleteBackgroundTaskCount = BackgroundTaskManagerUtil.getBackgroundTasksCount(groupId, ContactExportBackgroundTaskExecutor.class.getName(), false);
%>
