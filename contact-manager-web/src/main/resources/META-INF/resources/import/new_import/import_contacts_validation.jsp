        ...
        var liferayUpload = new Liferay.Upload(
            {
                ...
                'strings.dropFileText': '<liferay-ui:message key="drop-a-v-card-file-here-to-import" />',
        ...
        function(event) {
            ...
            exportImportOptions.plug(
                A.Plugin.IO,
                {
                    ...
                    <liferay-portlet:resourceURL copyCurrentRenderParameters="<%= false %>" id="importContacts" var="importContactsURL">
